...
Or you can create a [GitHub Issue](https://github.com/chenfeining/golangci-lint/issues/new) and we will integrate when time permits.
...
3. If it doesn't help create a [GitHub issue](https://github.com/chenfeining/golangci-lint/issues/new) with the output from the error and #2 above.
